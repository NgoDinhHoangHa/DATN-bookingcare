...
var UnoverlayVue = (() => {
  ...
  // src/hooks/meta.ts
  var import_vue_demi = __require("vue-demi");
  ...
  // src/hooks/holder.ts
  var import_vue_demi4 = __require("vue-demi");
  var import_mitt = __toESM(__require("mitt"));

  // src/helper/render.ts
  var import_vue_demi3 = __require("vue-demi");
  var import_pascal_case = __require("pascal-case");

  // src/helper/define.ts
  var import_vue_demi2 = __require("vue-demi");
  ...
  var import_vue_demi5 = __require("vue-demi");
  ...
  var import_vue_demi6 = __require("vue-demi");
