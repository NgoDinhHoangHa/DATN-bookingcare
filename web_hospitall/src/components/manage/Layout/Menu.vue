    ...
    export default {
        data() {
            return {
                ...
                { id: 2, name: 'Quản lý nghỉ', route: 'schedule', icon: 'calendar', role: 0 },
                { id: 3, name: 'Chuyên khoa', route: 'specicallists', icon: 'spreadsheet', role: 0 },
                { id: 4, name: 'Thời gian đặt', route: 'timebooks', icon: 'time', role: 0 },
                { id: 5, name: 'Bài viết', route: 'blogs', icon: 'pencil', role: 'all' },
                { id: 6, name: 'Lịch đặt khám', route: 'booklists', icon: 'calendar', role: 1 },
                { id: 7, name: 'Hỗ trợ', route: 'chats', icon: 'chat', role: 1 }]
            }
        },
        setup() {
