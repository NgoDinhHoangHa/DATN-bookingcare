...
import Schedule from "../components/manage/pages/Schedule";
...
const Admin_Router = [
  ...
  { path: "/admin/schedule", component: Schedule, name: "schedule", role: 0 },
  {
    path: "/admin/specicallists",
    component: SpecicalList,
    name: "specicallists",
    role: 0,
  },
